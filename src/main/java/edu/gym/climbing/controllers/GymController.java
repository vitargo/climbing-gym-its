...
public class GymController {
    ...
    @GetMapping
    @RequestMapping("/gym/climbers/{Id}")
    public String getGymClinbers(@PathVariable String id, Model model){
        return "gyms/climbers";
    }

    @PostMapping
    @RequestMapping("gym/register")
    public String addGym(){
        return "gym/registration";
    }

    @PostMapping
    @RequestMapping("gym/update/{Id}")
    public String updateGym(@PathVariable String id, Model model){
        return "gym/updatepage";
    }
